            ...
            {isOpen && (
                <div className="Main-Popup Main-Popup-Center">
                    <div className='Popup-Item'>
                        <p className='Main-Text-Accessibility'>{translations.logistics}</p>
                    </div>
                    <div className='Popup-Item'>
                        <p className='Main-Text-Accessibility'>{translations.humanResources}</p>
                    </div>
                    <div className='Popup-Item'>
                        <p className='Main-Text-Accessibility'>{translations.finance}</p>
                    </div>
                </div>
            )}
        </div>
